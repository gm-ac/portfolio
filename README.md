...
|----|-------------------------|-------------------------|-------------------|
|pet| [Исследование насколько тесно связаны между собой игроки КХЛ](project_of_proximity_in_KHL| Анализ кол-ва "рукопожатий" между хоккеистами КХЛ|   python, pandas, numpy, matplotlib, nx| 
